...
//CodeChef
app.get('/cc/:username',expressAsyncHandler(async(req,responce)=>{
...
//LeetCode
app.get('/lc/:username',expressAsyncHandler(async(req,res)=>{
...
//codeForces
app.get('/cf/:username',expressAsyncHandler(async(req,res)=>{
...
//Spoj
app.get('/spoj/:username',expressAsyncHandler(async(req,res)=>{
